...
export function AlertsTab({ showNewAlert, setShowNewAlert }: any) {
  return (
    <div className="space-y-6 animate-reveal">
      ...
      <div className="bg-white rounded-xl border border-primary/20 p-6 shadow-sm relative overflow-hidden group">
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1">
            <div className="font-extrabold text-xl text-slate-900 pr-8">Besoin critique : Donneurs O+ / O−</div>
            <div className="text-sm font-medium text-slate-600 mt-1 mb-4 flex items-center gap-2">
               Service de réanimation <span className="w-1 h-1 rounded-full bg-slate-300"></span> 3 poches manquantes
            </div>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-slate-700 font-medium mb-5 bg-slate-50 p-3 rounded-lg border border-slate-100">
              <span className="flex items-center gap-2 bg-white px-2 py-1 rounded shadow-sm border border-slate-100">
                <MapPin className="h-4 w-4 text-primary" /> CHU Casablanca
              </span>
              <span className="flex items-center gap-2 bg-white px-2 py-1 rounded shadow-sm border border-slate-100">
                <Bell className="h-4 w-4 text-blue-500" /> 45 notifications
              </span>
              <span className="flex items-center gap-2 bg-white px-2 py-1 rounded shadow-sm border border-slate-100">
                <Users className="h-4 w-4 text-success" /> <span className="text-success font-bold">3 réponses</span>
              </span>
            </div>
